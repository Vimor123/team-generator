# Team Generator Programs

Programs that assign any number of people to any number of teams
...
Team Generator programs are currently available in Python (elegant, clean), C (use with caution), Go (ugly) and Java (gay).
